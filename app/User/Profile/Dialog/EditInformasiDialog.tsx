...
export default function EditInformasiDialog({
  ...
  // Daftar bidang kerja berdasarkan tipe user
  const bidangKerjaOptions = {
    Dosen: [
      { value: "Prodi Informatika", label: "Prodi Informatika" },
      { value: "Prodi Teknik Sipil", label: "Prodi Teknik Sipil" },
      { value: "Prodi Teknik Komputer", label: "Prodi Teknik Komputer" },
    ],
    Karyawan: [
      { value: "Bagian Akademik", label: "Bagian Akademik" },
      { value: "Bagian Keuangan", label: "Bagian Keuangan" },
      { value: "Bagian Kemahasiswaan", label: "Bagian Kemahasiswaan" },
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue placeholder="Pilih bidang kerja" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                      {bidangKerjaOptions[
                        profile.tipeUser as keyof typeof bidangKerjaOptions
                      ]?.map((option) => (
